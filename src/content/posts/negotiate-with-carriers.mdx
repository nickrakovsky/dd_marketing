...
priority: Medium
description: >-
  Logistics leaders can create a lot of business value by understanding their
  carriers and building stronger relationships. Here's how to do it.
author: Joe Fitzpatrick
pubDate: 'Oct 11, 2024 10:08 AM'
updatedDate: 'Nov 10, 2025 6:13 PM'
cardImage: ../../assets/blog-images/negotiate-with-carriers-cover.webp
cardAlt: 'Two logistics professionals discussing carrier contract negotiations'
isHighlighted: false
showToc: true
postType:
...
2.  **Define and Monitor KPIs**. Use data and [scorecards](/posts/carrier-scorecards) to troubleshoot and drive improvements, not to penalize. Look at metrics like on-time performance through the lens of continuous improvement.
...
*   **Optimized Loading Dock Operations.** Data and predictability can help prevent bottlenecks and reduce [warehouse overtime](/posts/the-overtime-trap).
