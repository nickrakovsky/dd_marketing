...
priority: Low
description: >-
  This article explains where confusion starts, what each function does, and
  when you need scheduling, yard control, or a unified system to reduce
  congestion and detention.
author: Noel Moffatt
