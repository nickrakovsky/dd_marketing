...
**Autonomous Terminal Tractors -** Used in ports and bigger distribution centers to move trailers around the yard. Vendors like **Outrider,** **Kalmar,** and **TICO** are running pilots aimed at eliminating driver bottlenecks, reducing accidents, and keeping things moving around the clock. You need to map your yard properly and hook it up to a [yard management system](/posts/best-yard-management-options) to get these working.
