...
<LeadMagnetForm client:idle headline="Spreadsheet Template: Customizable Carrier Scorecard" eventName="$subscribescorecards" redirectUrl="/files/Carrier_Scorecard_Example_DataDocks.pdf" buttonText="Download" />
