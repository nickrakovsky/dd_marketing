...
relatedFeature: custom-rules
relatedFeatures: ['custom-rules']
...
*   [**Yard Management**](/datadocks-features/yard-management): Oversee the movement of trailers in and out of the facility's yard to prevent congestion and delays.
...
<RelatedFeatureCallout id="custom-rules" />
