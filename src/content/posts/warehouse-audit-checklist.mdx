...
Inventory discrepancies lead to stockouts, backorders, and "ghost inventory" (items the system thinks you have, but you don't). Regular auditing detects [shrinkage](/posts/yt-_tzt10q2yta) (theft, damage, or administrative error) early.
