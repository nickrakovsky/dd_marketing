...
priority: Medium
description: >-
  Inbound vs outbound logistics: what's different, where they collide at the
  dock, and how to fix dwell time and detention in 30 days.
author: Noel Moffatt
pubDate: 'Jan 12, 2026 7:59 PM'
updatedDate: 'Mar 11, 2026 2:06 PM'
cardImage: ''
cardAlt: 'Warehouse dock with inbound receiving and outbound shipping side by side'
isHighlighted: false
showToc: true
postType:
...
That's money flowing straight out of the logistics budget into carrier pockets because the dock couldn't process trucks on time. For more details on how carriers calculate these charges, see [the real cost of detention and accessorial fees](/posts/truck-detention-accessorial-fees).

### **Indirect Costs: Missed Windows and Lost Goodwill**

Beyond detention, dock bottlenecks create cascading failures:

**Missed delivery windows:** An outbound load sits at the dock for three hours instead of one. The truck leaves late, misses the [retailer's receiving window](/posts/retail-case-studies), and the shipment gets rejected. The facility eats the cost of re-delivery plus potential chargebacks.
...
**Overtime labor:** When inbound trucks arrive in a morning rush, receiving teams can't keep up. The backlog extends into the afternoon, forcing supervisors to authorize [overtime](/posts/the-overtime-trap) to clear it. That same pattern repeats on the outbound side when loads aren't staged on time.
