...
There are mature solutions available from large, legacy vendors. But they are nowhere near Fleetio in terms of user experience and support. More important than that is the amount of data that the Fleetio platform can produce, and the simplicity of integrating it with other business systems via [API or EDI](/posts/edi-vs-api).
...
Tulip lays the foundation that will one day let manufacturers build a [digital twin](/posts/logistics-digital-twin) of their entire production system.
...
[Dock scheduling](/posts/what-is-dock-scheduling) is a feature in many [warehouse management](/posts/how-to-overcome-the-top-8-warehouse-management-challenges) systems and some transportation platforms as well. The problem is it’s never very good. Most shipping and receiving coordinators end up resorting to a plethora of Excel spreadsheets and spend their days on the phone with carriers and suppliers to confirm details of each load, and update the data manually.
...
*   2020: [A Review of Further Directions for Artificial Intelligence, Machine Learning, and Deep Learning in Smart Logistics](https://www.mdpi.com/2071-1050/12/9/3760/pdf?version=1589265068)
