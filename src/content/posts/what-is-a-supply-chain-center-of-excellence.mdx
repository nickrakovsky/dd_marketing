...
priority: High
description: >-
  This piece explores the evolution, purpose, and transformative role of Supply
  Chain Centers of Excellence in modern logistics.
...
*   2017: Food manufacturer Lamb Weston Meijer reveals that its Supply Chain CoE team [considers possible global marketplace changes over the next 8 years in order to spot potential threats and opportunities](https://web.archive.org/web/20240807022404/https://www.supplychainmovement.com/inside-outside-perspective/).
...
A CoE team can be much more effective when it’s on-site. This can be a manufacturing facility or even a warehouse—a proving ground that helps ambitious managers [become a warehouse director](/posts/become-a-warehouse-director)—as it quickly becomes apparent what data is missing and what kind of technology will help the people working in the facility. The team’s stay can be long-term, or it can lead a change project, measure the results and then move on to a new location.
