...
priority: High
description: >-
  Mutual accountability sets the stage for a no-nonsense agreement: "Show up
  closer to your scheduled time, and we'll get your truck worked faster."
author: Joe Fitzpatrick
pubDate: 'Oct 9, 2023 1:37 PM'
updatedDate: 'Feb 27, 2026 2:24 PM'
cardImage: ../../assets/blog-images/truck-detention-accessorial-fees-cover.jpg
cardAlt: 'Truck driver waiting at a facility representing detention fee disputes'
isHighlighted: false
showToc: true
postType:
  discriminant: article
  value: {}
relatedFeature: carrier-self-scheduling
relatedFeatures: ['carrier-self-scheduling']
...
As Nick explains, relying on reactive, end-of-the-month arguments over massive invoices is a losing battle. To truly eliminate these costs, you need to understand the underlying mechanics of the industry and learn how to effectively [negotiate with carriers](/posts/negotiate-with-carriers). Here is your definitive, operational guide to settling driver detention disputes once and for all.
...
You cannot simply flip a switch to strict appointments. You must communicate the transition and update contracts, often using a carrot-and-stick approach: _”If you show up without an appointment, we’ll work you in, but don’t expect detention. If you book an appointment and arrive within an hour, we’ll turn you around in two hours or pay up without question.”_ For a deeper look at transitioning away from FCFS, see our guide on [time slot management](/posts/time-slot-management). 
...
Being fair means paying a driver if your dock genuinely holds them up. Their profit vanishes when their wheels stop moving, and holding an independent owner-operator for 8 hours without pay will quickly destroy your facility’s reputation. High dwell times hurt everyone — our guide on [dwell time in trucking](/posts/dwell-time-in-trucking) explains how to measure and reduce it.
...
And if your own facility is overwhelmed by unpredictable inbound LTLs, take a leaf out of the grocery playbook and transition your inbound terms to "collect." You can then hire a single regional carrier or 3PL to sweep your local or [nearshoring logistics](/posts/nearshoring-logistics) vendors and deliver tightly managed, consolidated FTLs to your dock.
...
<RelatedFeatureCallout id="carrier-self-scheduling" />
...
The typical facility wastes between $15,000 and $35,000 a year on detention costs. Operationally, that is the equivalent of taking one of your forklifts and setting it on fire just because a truck waited longer than it should have. If you haven't already, read our complete guide on [what dock scheduling is and why it matters](/posts/what-is-dock-scheduling) to understand the foundation that makes detention management possible.
...
**Related reading:** Want to hold carriers accountable beyond detention? Learn how to build a [carrier scorecard program](/posts/carrier-scorecards) that tracks on-time performance, or explore our [complete guide to avoiding demurrage and detention charges](/posts/how-to-avoid-demurrage-and-detention-charges-throughout-the-supply-chain) across the entire supply chain.
