    ...
    <>
      ...
      >
        <div className={`flex items-center justify-center flex-shrink-0 ${isDesktop ? "h-10 w-10" : "h-8 w-8"}`}>
          <img src={images.g2} alt="G2" width={isDesktop ? 40 : 32} height={isDesktop ? 40 : 32} className="w-full h-full object-contain" />
        </div>
      ...
      >
        <img src={images.capterra} alt="Capterra" width={24} height={24} className={`${isDesktop ? "h-6 w-6" : "h-6 w-6"} flex-shrink-0`} />
