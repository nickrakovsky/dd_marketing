import type { SystemMatch } from "./YardTypeEngine";

// Loaded on category interaction; the initial card grid needs no recommendation text.
export const YARD_SYSTEM_MATCHES: Record<string, SystemMatch[]> = {
  "warehouse-dc": [
          {
            name: "DataDocks",
            score: 99,
